...
def custom_insert(input_list, index, value):
    ...
    for item in input_list:
        if index_num == index: # if index num is equal to index
            input_list[index:]= [value] + input_list[index:] #insert value at index num
        index_num+=1
...
def custom_pop(input_list):
    ...
    """
    pop_item=input_list[-1] # assigned pop value to pop item

    input_list[:]= input_list[:-1] # all indeces point now to all indices in list excluding the last 
...
def custom_index(input_list, value):
    ...
    for item in input_list: 
        if item == value: #if item in list matches value break loop and assign value index the index number
            value_index = index 
            break
        index+=1 #incriment index number by one until item matches value
...
def custom_count(input_list, value):
    ...
    for item in input_list: 
        if item == value: #if item in list matches value break loop and assign value index the index number
            count+=1 #incriment count number by one if item matches value
        else:
            pass
